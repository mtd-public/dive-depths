 ...
 *  (not a 3D element) so it reads crisply regardless of camera angle. */
export function BossBanner({ active, hpFrac }: BossBannerProps) {
  ...
  return (
    <div className="boss-banner">
      ...
      <span className="boss-banner__label">Boss Fight</span>
    </div>
  )
}
